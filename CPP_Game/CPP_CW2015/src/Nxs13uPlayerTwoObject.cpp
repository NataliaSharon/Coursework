...
Nxs13uPlayerTwoObject::Nxs13uPlayerTwoObject(Nxs13uMain* pEngine, int radius, int colour, int x, int y)
...
// Destructor 
Nxs13uPlayerTwoObject::~Nxs13uPlayerTwoObject(void)
{
}


void Nxs13uPlayerTwoObject::Draw()
{
