...
void BaseEngine::CreateObjectArray(int iNumberObjects)
{
	...
	m_ppDisplayableObjects.reserve(iNumberObjects + 1);
}
...
void BaseEngine::UpdateAllObjects( int iCurrentTime )
{
	...
	{
		for ( int i = 0 ; m_ppDisplayableObjects.at(i) != NULL ; i++ )
		{
			m_ppDisplayableObjects.at(i)->DoUpdate(iCurrentTime);
...
void BaseEngine::UndrawObjects()
{
	...
	if ( !m_ppDisplayableObjects.empty() )
	{
		for (int i = 0; m_ppDisplayableObjects.at(i) != NULL; i++)
		{
			m_ppDisplayableObjects.at(i)->RedrawBackground();
			if ( m_iDrawableObjectsChanged )
				return; // Abort! Something changed in the array
		}
	}
...
void BaseEngine::DrawObjects()
{
	...
	if ( !m_ppDisplayableObjects.empty() )
	{
		for (int i = 0; m_ppDisplayableObjects.at(i) != NULL; i++)
		{
			m_ppDisplayableObjects.at(i)->Draw();
			if ( m_iDrawableObjectsChanged )
				return; // Abort! Something changed in the array
		}
	}
...
void BaseEngine::NotifyAllObjects( int iSignalNumber )
{
	if ( !m_ppDisplayableObjects.empty() )
	{
		for ( int i = 0; m_ppDisplayableObjects.at(i) != NULL; i++ )
		{
			m_ppDisplayableObjects.at(i)->Notify( iSignalNumber );
		}
	}
}
...
int BaseEngine::NotifyAllObjectsGetCountNonZero( int iSignalNumber )
{
	...
	if ( !m_ppDisplayableObjects.empty())
	{
		for ( int i = 0; m_ppDisplayableObjects.at(i) != NULL; i++ )
		{
			if ( m_ppDisplayableObjects.at(i)->Notify( iSignalNumber ) != 0 )
				iReturn++;
		}
	}
	return iReturn;
...
int BaseEngine::NotifyAllObjectsGetSum( int iSignalNumber )
{
	...
	if ( !m_ppDisplayableObjects.empty() )
	{
		for ( int i = 0; m_ppDisplayableObjects.at(i) != NULL; i++ )
		{
			iReturn += m_ppDisplayableObjects.at(i)->Notify(iSignalNumber);
		}
	}
	return iReturn;
}
...
int BaseEngine::NotifyAllObjectsGetMax( int iSignalNumber )
{
	...
	if ( !m_ppDisplayableObjects.empty() )
	{
		for ( int i = 0; m_ppDisplayableObjects.at(i) != NULL; i++ )
		{
			int ival = m_ppDisplayableObjects.at(i)->Notify( iSignalNumber );
			if ( ival > iReturn )
				iReturn = ival;
		}
	}
