...
public interface IG52APRClient {
    ...
    public abstract String httpGet(String url) throws ClientProtocolException, IOException;
     ...
     * @throws IOException 
     */
    public abstract String httpHead(String url) throws IOException;

    //sends data to server using httpPost, returns body of response
     ...
     * @throws ClientProtocolException 
     */
    public abstract String httpPost(String url, String body) throws ClientProtocolException, IOException;
     ...
     * @throws IOException 
     */
    public abstract String httpPost(String url, ArrayList<NameValuePair> nameValuePairs) throws IOException;
